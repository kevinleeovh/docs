...
```
laptop$mongosh "mongodb+srv://<username>:<password>@<service hostname>/admin"
```
...
```
laptop$mongosh "mongodb+srv://bastien:Mysup3rs3cur3p4ssw0rd@mongodb-acf37bdb-oe3fcfb34.database.cloud.ovh.net/admin"
```
